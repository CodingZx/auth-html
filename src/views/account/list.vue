     ...
     <div class="filter-container" >
        <el-form :inline="true" >
          <el-form-item label=" 账号：">
              <el-input v-model.trim="listQuery.userName" style="max-width: 200px" />
          </el-form-item>

          <el-form-item label=" 姓名：">
              <el-input v-model.trim="listQuery.realName" style="max-width: 200px" />
          </el-form-item>
          <el-form-item label="">
...
//导出属性到页面中使用
const { list, listLoading, listQuery, count, dialogFormVisible, temp, roles, textMap, dialogStatus } = toRefs(state)
